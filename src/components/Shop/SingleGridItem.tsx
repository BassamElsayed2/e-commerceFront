...
const SingleGridItem = ({ item }: { item: Product }) => {
  ...
  // update product details for shop details page
  ...
  return (
    <div className="group">
      <div className="relative overflow-hidden rounded-lg bg-white shadow-1 h-[320px] flex items-center justify-center mb-4">
