...
const Header = () => {
  ...
  const options = [
    ...
    { label: t("desktop"), value: "1" },
    { label: t("laptop"), value: "2" },
    { label: t("monitor"), value: "3" },
    { label: t("phone"), value: "4" },
    { label: t("watch"), value: "5" },
    { label: t("mouse"), value: "6" },
            ...
            <div className="max-w-[475px] w-full">
              <form>
                <div className="flex items-center">
                  {locale === "en" && <CustomSelect options={options} />}
                  ...
                  {locale === "ar" && <CustomSelect options={options} />}
                </div>
              </form>
            </div>
          </div>
